import json
from sqlite3 import Connection as SQLite3Connection, Date
...
def create_blog_post(user_id):
    ...
    new_blog_post = BlogPost(
        title=ht.get_key_value("title"),
        body=ht.get_key_value("body"),
        date=ht.get_key_value("date"),
        user_id=ht.get_key_value("user_id")
    )
